  ...
  return (
    <div>
        ...
        <div class ="sideBox">
            ...
            <NavLink to="/customer/Dashboard" style={{ textDecoration: 'none' }}>
            ...
            <NavLink to="/viewFeedback" style={{ textDecoration: 'none' }}>
            <p className="each_fun">{props.fun4}</p>
            </NavLink>
            <NavLink to="" style={{ textDecoration: 'none' }}>
            <p className="each_fun">{props.fun5}</p>
            </NavLink>
            <NavLink to="/customer/report" style={{ textDecoration: 'none' }}>
